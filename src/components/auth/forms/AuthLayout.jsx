...
const AuthLayout = ({ children, title = "Find Your Perfect Property", description = "Join thousands of users finding their dream homes with DomiHive's verified properties and professional management.", features = [] }) => {
