...
const Signup = () => {
  ...
  // Updated image paths for new project
  const IMAGES = {
    icon: "/src/assets/domihive-lcon.png", // Same path
    logo: "/src/assets/domihive-logo.png", // Same path
  ...
  const handleSubmitStep3 = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Redirect to homepage after signup (not dashboard)
        setTimeout(() => {
          navigate("/");
        }, 1500);
      } else {
      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            value={formData.otp}
            onChange={handleChange}
            className={`w-full px-4 py-3 text-center text-2xl font-mono border rounded-lg focus:ring-2 focus:ring-[#9F7539] focus:border-transparent transition-colors ${
                  ...
                  {stepNum < 3 && (
                    <div
                      className={`w-12 lg:w-16 h-1.5 rounded-full ${
                        step > stepNum ? "bg-[#9F7539]" : "bg-gray-200"
                      }`}
                    />
                  )}
                </React.Fragment>
            ...
            <div className="flex justify-between mt-3 px-2">
              <span
                className={`text-sm font-medium ${
                  step >= 1 ? "text-[#9F7539]" : "text-gray-400"
                }`}
              >
                Basic Info
              </span>
              <span
                className={`text-sm font-medium ${
                  step >= 2 ? "text-[#9F7539]" : "text-gray-400"
                }`}
              >
                OTP Verification
              </span>
              <span
                className={`text-sm font-medium ${
                  step >= 3 ? "text-[#9F7539]" : "text-gray-400"
                }`}
              >
                Profile Setup
              </span>
