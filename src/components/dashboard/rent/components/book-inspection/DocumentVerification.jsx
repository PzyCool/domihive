...
const DocumentVerification = () => {
  return (
    <div className="document-verification mb-10 pb-8 border-b border-[#e2e8f0]">
      ...
      {/* Important Notice */}
      <div className="notice-box bg-gradient-to-r from-[rgba(59,130,246,0.08)] to-[rgba(99,102,241,0.08)] p-4 rounded-lg border-l-4 border-[#3b82f6] flex items-start gap-3 mb-6">
      ...
      {/* Documents Checklist */}
      <div className="documents-box bg-[#f8fafc] p-6 rounded-xl border border-[rgba(14,31,66,0.1)] mb-6">
        {/* Required Document 1 */}
        <div className="doc-row pb-4 mb-4 border-b border-[rgba(0,0,0,0.08)]">
          <div className="ml-4">
      ...
      <div className="process-box bg-gradient-to-r from-[rgba(16,185,129,0.05)] to-[rgba(5,150,105,0.05)] p-6 rounded-xl border border-[rgba(16,185,129,0.2)]">
