...
const TermsAndConditions = ({ checked, onChange }) => {
  return (
    <div className="terms-container mb-8">
      <div className="terms-box bg-[#f8fafc] p-6 rounded-xl border border-[rgba(14,31,66,0.1)]">
        ...
        <ul className="terms-list space-y-2 ml-8 mt-3">
