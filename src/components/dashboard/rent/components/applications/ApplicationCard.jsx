...
const ApplicationCard = ({ application, onAction }) => {
  ...
  return (
    <div className="application-card bg-white rounded-2xl shadow-lg border border-[#e2e8f0] overflow-hidden flex flex-col h-full">
      <div className="flex gap-4 p-5">
        ...
        <div className="flex-1 flex flex-col justify-between">
          <div>
            ...
            <p className="text-sm font-medium text-[#0e1f42] mt-2">{`₦${application.property.price.toLocaleString()}/year`}</p>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#0e1f42] to-[#1a2d5f] text-white text-xs font-semibold px-4 py-2 rounded-full shadow-sm hover:from-[#1a2d5f] hover:to-[#0e1f42] transition-colors"
            >
              {actionLabel}
            </button>
          </div>
